...
Graduada em Neurociência pela Universidade Duke (EUA) em 2021, trago uma visão única para o campo da Inteligência Artificial:

- Compreensão de processos cognitivos e aprendizado humano aplicados ao design de algoritmos.  
- Inspiração biológica para construção de redes neurais artificiais e sistemas de recomendação.  
- Experiência em conectar conceitos de memória, percepção e tomada de decisão ao desenvolvimento de soluções com IA generativa e machine learning.  

Essa formação me permite aplicar conceitos biológicos em IA — como redes neurais, memória associativa e aprendizado por reforço — criando soluções mais humanas, explicáveis e alinhadas às necessidades reais dos usuários.
